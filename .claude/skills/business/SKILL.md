...
2. **REQUIRED:** Use `helpers/knowledge/business_context.py` → `load_business_context(org_path)` to load data
...
**Implementation:**
1. Use `helpers/knowledge/business_context.py` → `get_glossary()`, `get_products()`, etc.
