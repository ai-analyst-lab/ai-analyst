...
name: metric-spec
description: >-
  Define any metric completely with a standardized template: calculation, denominator, time
  window, filters, interpretation. Trigger on "define this metric", "how should we measure X?",
  "what's the right way to calculate Y?", "document our metrics", "create a metric definition",
  "different teams are measuring this differently", or when a metric is used in analysis without a
  clear specification.
---
