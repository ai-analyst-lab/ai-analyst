...
- **Feasibility flag (MANDATORY):** VIABLE (up to 4 weeks), MARGINAL (4-8 weeks), NOT_VIABLE (over 8 weeks, consider alternatives). Same scale the power script returns.

**Anti-pattern to avoid:** Estimating "2-4 weeks" without classifying as VIABLE/MARGINAL/NOT_VIABLE. The flag tells stakeholders whether the test is worth running.

If feasibility is MARGINAL or NOT_VIABLE, suggest alternatives:
...
After generating the brief, the next step is ALWAYS the Experiment Designer agent (`agents/experiments/experiment-designer.md`). Pass the hypothesis, metric definitions, and feasibility estimate as inputs.
...
8. **Never omit the feasibility flag** — VIABLE/MARGINAL/NOT_VIABLE is mandatory
