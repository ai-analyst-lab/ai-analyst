...
- **Connection failures:** report the failure and offer the next viable path (CLAUDE.md "Never dead-end"); note which source is active.
...
- **Runs alongside `data-quality-check`**: this skill is DQ at the dataset level; table-scoped DQ still fires on table-specific questions.
