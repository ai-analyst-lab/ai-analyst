...
This guide configures AI Analyst for your Snowflake data warehouse with dbt-modeled tables.
...
AI Analyst uses the Snowflake dialect adapter (`helpers/data/dialects/snowflake.py`) which handles:
...
Add your own dialect extensions in `helpers/data/dialects/snowflake.py`:
