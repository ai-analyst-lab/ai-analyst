"""Tests for helpers.provenance.query_log — JSONL query logging, matching, coverage."""
...
from helpers.provenance.query_log import (
    _log_path,
    append_entry,
    read_log,
    match_claims,
...
def tmp_working(tmp_path, monkeypatch):
    ...
    import helpers.provenance.query_log as ql_mod
