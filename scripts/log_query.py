#!/usr/bin/env python3
"""CLI wrapper for query logging — the bridge between agent instructions and helpers/provenance/query_log.py.
...
from helpers.provenance.query_log import append_entry
...
def main():
    ...
    if args.log_path:
        import helpers.provenance.query_log as ql
