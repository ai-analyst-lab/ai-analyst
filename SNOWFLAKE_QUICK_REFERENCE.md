# Snowflake + AI Analyst — Quick Reference
...
AI Analyst uses `helpers/data/dialects/snowflake.py` to generate warehouse-specific SQL:
...
| `helpers/data/dialects/snowflake.py` | SQL dialect adapter |
