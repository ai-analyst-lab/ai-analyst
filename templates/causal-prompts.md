...
Three annotated prompt templates for the most common causal inference scenarios. Each prompt is designed to run with the AI Analyst's causal inference toolkit (`helpers/stats/experiment_stats/causal/`).
...
Use: from helpers.stats.experiment_stats.causal import pre_post_analysis
```
...
Use: from helpers.stats.experiment_stats.causal import did_basic, parallel_trends_test
```
...
Use: from helpers.stats.experiment_stats.causal import propensity_match, balance_table, love_plot
