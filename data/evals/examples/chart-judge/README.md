...
```text
python3 data/evals/examples/chart-judge/score_alignment.py \
  --human data/evals/examples/chart-judge/reviewed-set/human-labels.csv \
  --grader data/evals/examples/chart-judge/captured/initial-verdicts.csv
```
