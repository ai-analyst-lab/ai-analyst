...
Read `templates/presentation-standards.md`. Load the theme specified by {{THEME}}. Extract:
...
## Skills Used
- `templates/presentation-standards.md` — for theme selection, slide layout rules, color palettes, font specifications, and content density guidelines
