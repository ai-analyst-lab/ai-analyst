...
**Checks to run:**
```python
from helpers.stats.experiment_stats.causal import check_parallel_trends
from helpers.stats.experiment_stats.causal import event_study
...
**Checks to run:**
```python
from helpers.stats.experiment_stats.causal import check_common_support, balance_table
...
3. **Uses coded helpers** — statistical checks go through `helpers/stats/experiment_stats/causal/`.
