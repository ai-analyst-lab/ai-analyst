...
Follow the skill's Step 5: upload each chart to the user's Google Drive via the chart-to-drive skill. Never use a public file host; if Drive is unavailable, create the page without images and list the chart paths for manual upload.
