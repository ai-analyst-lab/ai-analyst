...
```python
from helpers.viz.chart_helpers import CHART_FIGSIZE
...
```python
from helpers.viz.chart_helpers import format_date_axis
...
```python
from helpers.viz.chart_helpers import swd_style, highlight_bar, action_title, save_chart
...
```python
plt.style.use("helpers/viz/analytics_chart_style.mplstyle")
```

### Color Palette Access

```python
from helpers.viz.chart_helpers import swd_style
