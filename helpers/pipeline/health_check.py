...
def check_helper_imports() -> dict:
    ...
    """
    modules_to_check = [
        "helpers.data.data_helpers",
        "helpers.viz.chart_helpers",
        "helpers.data.sql_helpers",
        "helpers.stats.stats_helpers",
        "helpers.pipeline.error_helpers",
        "helpers.pipeline.file_helpers",
        "helpers.data.schema_profiler",
        "helpers.data.connection_manager",
        "helpers.data.sql_dialect",
        "helpers.provenance.lineage_tracker",
        "helpers.stats.analytics_helpers",
    ]
