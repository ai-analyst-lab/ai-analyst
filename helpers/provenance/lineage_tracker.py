...
Usage:
    from helpers.provenance.lineage_tracker import LineageTracker, track, get_tracker
    ...
    def record(self, step, agent, inputs, outputs, metadata=None, provenance_block=None):
        ...
        Args:
            ...
            provenance_block: Optional ProvenanceBlock dict from
                helpers.provenance.provenance_assembler. When provided, attached to the
...
def track(step, agent, inputs, outputs, metadata=None, provenance_block=None):
    ...
    Args:
        ...
        provenance_block: Optional ProvenanceBlock dict from
            helpers.provenance.provenance_assembler.
    """
